...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      @if( Route::has('login'))
      @auth
      <a href="{{ url('myappointment') }}" class="appointment-btn scrollto"><span class="d-md-inline">My Appointment</a>

      <form method="POST" action="{{ route('logout') }}">
        @csrf
            <a class="appointment-btn scrollto" href="{{ route('logout') }}" onclick="event.preventDefault();
      ...
      @else
      <a href="{{ route('login') }}" class="appointment-btn scrollto"><span class="d-md-inline">Login</a>
      <a href="{{ route('register') }}" class="appointment-btn scrollto"><span class="d-md-inline">Register</a>
      @endauth
      @endif
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <form action="{{ url('/appointment') }}" method="post" role="form" class="php-email-form">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="doctor" id="doctor" class="form-select">
                ...
                <option value="{{ $data->name }}">{{ $data->name }} => {{ $data->specialty }}</option>
                @endforeach
              </select>
               @error('doctor')
               <div class="error text-danger">{{ $message }}</div>
          ...
          <div class="col-md-12 form-group mt-3">
            <textarea name="message" id="" rows="10" class="form-control" placeholder="Enter your message"></textarea>
            @error('message')
               <div class="error text-danger">{{ $message }}</div>
               @enderror
          </div>
          <div class="text-center mt-4"><button type="submit">Make an Appointment</button></div>
        </form>
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="row">
          @foreach( $doctors as $profile)
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset('/backend/doctorsimage/'.$profile->image) }}" class="img-fluid" alt=""></div>
